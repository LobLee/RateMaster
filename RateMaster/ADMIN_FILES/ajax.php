...
if(isset($_POST['displayUserInFrate']) && $_POST['displayUserInFrate'] == true){
...
if(isset($_POST['toDeleteUserInFrate']) && $_POST['toDeleteUserInFrate'] == true){
...
if(isset($_POST['displayTableForManageInFrate']) && $_POST['displayTableForManageInFrate'] == true){
            ...
            if (mysqli_num_rows($result) > 0) {
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                //   $seller = $row['seller'];
                  ...
                  $table .= '<tr>
                      <td scope="row" class="text-center align-middle">' . $number . '</td>
                      <td scope="row" class="text-center align-middle">' . $filename . '</td>
...
if(isset($_POST['displayTableForActivityLogFrate']) && $_POST['displayTableForActivityLogFrate'] == true){
