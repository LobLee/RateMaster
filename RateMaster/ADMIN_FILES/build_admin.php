...
<body>
    ...
    <div class="wrapper">
        <main>
                <h1 class = "rateText">Build-Rate</h1>
                ...
                <div class="components">
                    <div class="section1">
                        ...
                        <div class="box">
                                ...
                                <div class="dis">
                                        <h6>Click here to proceed to Build Rate Activity Logs</h6>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="section2">
                                ...
                                <a href="b_manage.php">
                                        ...
                                        <div class="dis">
                                                <h6>Click here to proceed to Build Rate Management</h6>
                                        </div>
                                    </div>
                                </a>
